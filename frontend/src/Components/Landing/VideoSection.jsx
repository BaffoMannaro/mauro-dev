        ...
        <div className="xl:h-screen bg-supero-dark-grey relative flex flex-col items-center justify-center">
            <div className="px-4 xl:hidden">
                <p className="title mb-2">
                    ...
                    <span className="hidden xl:inline">Watch it at work</span>
                </p>
            </div>
            {!isVideoPlaying && (
                <div className="xl:absolute z-10 text-white xl:text-center px-4">
                    ...
                    <button
                        onClick={handleStartVideo}
                        className=" group relative overflow-hidden bg-[#CCE535] hover:bg-[#2E2E33] text-[#2E2E33] hover:text-white px-4 py-2.5 transition-all duration-300 font-extrabold hidden xl:flex items-center text-[16px] uppercase tracking-wider min-w-[250px] justify-between mx-auto mt-6"
                    >
                        <span className="relative z-10">WATCh VIDEO</span>

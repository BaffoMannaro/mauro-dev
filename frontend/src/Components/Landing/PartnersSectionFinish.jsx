    ...
    return (
        <>
            <div className="bg-supero-dark-grey flex flex-col xl:flex-row xl:justify-evenly py-12">
                <div className="w-full xl:w-1/4 px-8 flex flex-row items-center relative ">
                ...
                <div className="w-full xl:w-3/4 xl:max-w-[870px] flex flex-row items-center xl:flex-wrap px-0 overflow-x-scroll overflow-y-hidden">
                    ...
                    <div className="w-full min-w-[180px] xl:w-1/4 max-w-[280px] 2xl:max-w-[440px] h-[122px] 2xl:h-[140px] flex justify-center items-center me-8 xl:me-0">
